...
$res = $conn->query("SELECT artist, title FROM logging WHERE active = 1 AND (DATE_SUB(CURDATE(),INTERVAL 15 MINUTE ) <= datetime) AND (title != '' AND artist != '') ORDER BY datetime DESC LIMIT 0,1;");
